...
class InformationHandleTest {
	...
	void testGenerateAssignments() {
		ArrayList<Assignment> assignments = InformationHandle.generateAssignments(osRoster, supplyRoster, absences, 2, 4);
	...
	void testGetAvailabilityOSOnly() {
		ArrayList<OnStaffTeacher> r = InformationHandle.getAvailability(0, osRoster, 2, 4);
	...
	void testGetAvailabilityAllTeachers() {
		ArrayList<Teacher> r = InformationHandle.getAvailability(0, osRoster, supplyRoster, 2, 4);
	...
	void testGetAssignableTeacherListOSOnly() {
		ArrayList<Assignment> a = InformationHandle.generateAssignments(osRoster, supplyRoster, absences, 2, 4);
